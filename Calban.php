...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-5" style="background: black;">GRID</div>
        </div>

        <div class="row">
            <div class="col-md-6" style="background: blue;">GRID</div>
    ...
    <div class="container-fluid">
        <header>
            <h1 class="jumbotron">Container fluid</h1>
        </header>
    ...
    <div class="Container">
        <header>
            <h1 class="jumbotron">Container</h1>
        </header>
